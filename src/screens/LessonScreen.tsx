...
import type { BallBrandOption, BallColorOption, LessonMode, LessonReviewClip } from '../types/app';
      ...
      <Modal visible={showDribbleGuide} transparent animationType="fade" onRequestClose={closeDribbleGuide}>
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            {dribbleGuideStep === 0 ? (
              <>
                ...
                <TextInput
                  ...
                  maxLength={3}
                />
                <Text style={styles.modalHint}>입력한 횟수만큼 드리블하면 자동으로 녹화가 끝나고 리뷰를 시작합니다.</Text>
              </>
            ) : null}
            ...
            {dribbleGuideStep === 3 ? (
              <>
                <Text style={styles.modalBody}>정해준 드리블 횟수동안 영상을 녹화해 레슨하겠습니다.</Text>
